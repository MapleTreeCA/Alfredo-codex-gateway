...
export GATEWAY_STT_INTERIM_INTERVAL="${GATEWAY_STT_INTERIM_INTERVAL:-900ms}"
export GATEWAY_STT_INTERIM_MIN_AUDIO="${GATEWAY_STT_INTERIM_MIN_AUDIO:-1200ms}"
...
echo "  max_turn=${GATEWAY_SESSION_MAX_TURN} tts_max_duration=${GATEWAY_TTS_MAX_DURATION} stt_streaming=${GATEWAY_STT_STREAMING_ENABLED} interval=${GATEWAY_STT_INTERIM_INTERVAL} min_audio=${GATEWAY_STT_INTERIM_MIN_AUDIO} stt_lang=${OPENAI_STT_LANGUAGE}"
echo "  opus_frame_ms=${GATEWAY_OPUS_FRAME_DURATION_MS} downlink_bitrate=${GATEWAY_DOWNLINK_OPUS_BITRATE}"
